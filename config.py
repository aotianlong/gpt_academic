...
AVAIL_LLM_MODELS = ["gpt-3.5-turbo", "gpt-3.5-turbo-16k", "gpt-4", "gpt-4-32k"]
...
API_URL_REDIRECT = {"https://api.openai.com/v1/chat/completions": "https://openai.yingjin.pro/v1/chat/completions"}
